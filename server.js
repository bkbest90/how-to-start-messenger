  ...
  for (let i = 0; i < messaging_events.length; i++) {
    ...
    if (event.message && event.message.text) {
      ...
      var location = event.message.text
            var weatherEndpoint = 'http://api.openweathermap.org/data/2.5/weather?q=' +location+ '&units=metric&appid=053b515dfaaa5b474e6701cdab179084'
            request({
              url: weatherEndpoint,
              json: true
              ...
              try {
                ...
                sendTextMessage(sender, "Today is " + condition.temp + " Celsius in " + location + weather.main);
              } catch(err) {
